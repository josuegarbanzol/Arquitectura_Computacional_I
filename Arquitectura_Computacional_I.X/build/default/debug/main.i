...
# 625 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC16F1xxxx_DFP/1.29.444/xc8\\pic\\include/pic_as_chip_select.inc" 3
# 1 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC16F1xxxx_DFP/1.29.444/xc8\\pic\\include\\proc/pic16f18877.inc" 1 3
# 33 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC16F1xxxx_DFP/1.29.444/xc8\\pic\\include\\proc/pic16f18877.inc" 3
INDF0 equ 0000h
...
# 27037 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC16F1xxxx_DFP/1.29.444/xc8\\pic\\include\\proc/pic16f18877.inc" 3
...
psect udata_bank38,class=BANK38,space=1,noexec
psect udata_bank39,class=BANK39,space=1,noexec
psect udata_bank40,class=BANK40,space=1,noexec
psect udata_bank41,class=BANK41,space=1,noexec
psect udata_bank42,class=BANK42,space=1,noexec
psect udata_bank43,class=BANK43,space=1,noexec
psect udata_bank44,class=BANK44,space=1,noexec
psect udata_bank45,class=BANK45,space=1,noexec
psect udata_bank46,class=BANK46,space=1,noexec
psect udata_bank47,class=BANK47,space=1,noexec
psect udata_bank48,class=BANK48,space=1,noexec
psect udata_bank49,class=BANK49,space=1,noexec
psect udata_bank50,class=BANK50,space=1,noexec
...
# 626 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC16F1xxxx_DFP/1.29.444/xc8\\pic\\include/pic_as_chip_select.inc" 2 3
...
;--------------------------------------------------------------------------------------------------------------------------
    ...
    ; === CONFIG1 (0x8007) ===
    CONFIG FEXTOSC = OFF ; sin oscilador externo
    CONFIG RSTOSC = HFINT32 ; oscilador interno de 64 MHz
    CONFIG CLKOUTEN = OFF
    CONFIG CSWEN = ON
    CONFIG FCMEN = OFF
...
delay_mid: DS 1 ; contador medio
delay_inner: DS 1 ; contador interno
...
main:
    ; --- Deshabilitar analog en PORTB y PORTD ---
    banksel ANSELB
    clrf ANSELB ; ((PORTB) and 07Fh), 0, ((PORTB) and 07Fh), 1 como digital
    banksel ANSELD
    clrf ANSELD ; ((PORTD) and 07Fh), 0, ((PORTD) and 07Fh), 1 como digital

    ; --- TRISB: ((PORTB) and 07Fh), 0 y ((PORTB) and 07Fh), 1 como entradas ---
    banksel TRISB
    bsf TRISB, 0 ; ((PORTB) and 07Fh), 0 entrada (SW1 modo)
    bsf TRISB, 1 ; ((PORTB) and 07Fh), 1 entrada (SW2 frecuencia)

    ; --- TRISD: ((PORTD) and 07Fh), 0 y ((PORTD) and 07Fh), 1 como salidas ---
    banksel TRISD
    bcf TRISD, 0 ; ((PORTD) and 07Fh), 0 salida (LED GREEN)
    bcf TRISD, 1 ; ((PORTD) and 07Fh), 1 salida (LED RED)
...
loop:
    banksel PORTB
    btfss PORTB, 0 ; ¿SW1 alto? (modo parpadeo)
    goto modo_fijo ; No -> LEDs fijos

    ; --- MODO PARPADEO ---
    ; Revisar SW2 para frecuencia
    banksel PORTB
    btfss PORTB, 1 ; ¿SW2 alto? (4 Hz)
    goto parpadeo_2hz

parpadeo_4hz:
    ; Periodo 4Hz = 250ms total -> 125ms ON, 125ms OFF
    banksel LATD
    bsf LATD, 0 ; GREEN ON
    bcf LATD, 1 ; RED OFF
    call delay_125ms
    ...
    banksel LATD
    bcf LATD, 0 ; GREEN OFF
    bsf LATD, 1 ; RED ON
    call delay_125ms
    goto loop

parpadeo_2hz:
    ; Periodo 2Hz = 500ms total -> 250ms ON, 250ms OFF
    banksel LATD
    bsf LATD, 0 ; GREEN ON
    bcf LATD, 1 ; RED OFF
    call delay_250ms
...
; ============================================================
; SUBRUTINAS DE DELAY
; Fosc = 64 MHz -> Fciclo = 16 MHz -> 1 ciclo = 62.5 ns
; Un loop de 3 instrucciones = 3 ciclos = 187.5 ns
; ============================================================

; --- delay_250ms ~ 250ms ---
; Necesitamos 250,000,000 ns / 62.5 ns = 4,000,000 ciclos
; Con 3 loops anidados de 8 bits máximo:
; inner(200) x mid(200) x outer(100) = 4,000,000 ciclos ✓
delay_250ms:
    movlw 100
    movwf delay_outer
d250_outer:
...
; --- delay_125ms ~ 125ms ---
; outer(50) x mid(200) x inner(200) = 2,000,000 ciclos ✓
delay_125ms:
    movlw 50
    movwf delay_outer
d125_outer:
